...
link "commands/vault-relink.md"
link "commands/devils-advocate.md"
link "commands/furikaeri.md"
link "commands/morning-life.md"
link "commands/morning-life-categories.json"
# use:work — 仕事用PCでも使うスキル（frontmatter に use: work 記載）
...
link_dir "skills/caveman"
link_dir "skills/config-audit"
